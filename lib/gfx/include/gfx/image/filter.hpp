...
struct FilterExpression {
    typedef ChannelType value_type;

    [[nodiscard]] constexpr auto operator()(ChannelType v) const noexcept { return static_cast<const E &>(*this)(v); }
};
...
struct UnaryOpExpression : public FilterExpression<UnaryOpExpression<Op>> {
    ...
    constexpr auto operator()(ChannelType v) const noexcept { return op(v); }
...
struct UnarySequenceExpression : public FilterExpression<UnarySequenceExpression<E0, E1>> {
    ...
    constexpr auto operator()(ChannelType v) const noexcept { return f1(f0(v)); }
...
constexpr auto Lerp(ChannelType min, ChannelType max) noexcept { return Oper([min, max](ChannelType v) { return Maths::Lerp(min, max, v); }); }

constexpr auto InvLerp(ChannelType min, ChannelType max) noexcept { return Oper([min, max](ChannelType v) { return Maths::InvLerp(min, max, v); }); }

constexpr auto Clamp(ChannelType min, ChannelType max) noexcept { return Oper([min, max](ChannelType v) { return std::clamp(v, min, max); });  }
